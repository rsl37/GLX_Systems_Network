...
export function AdminPage() {
  ...
  const getSecurityLevelBadge = (level: string) => {
    switch (level) {
      ...
      case 'high':
        return (
          <Badge className='bg-gradient-to-r from-blue-500 to-cyan-500 text-white'>HIGH</Badge>
        );
      case 'medium':
        return (
      ...
      case 'low':
        return <Badge className='bg-gradient-to-r from-red-500 to-pink-500 text-white'>LOW</Badge>;
      default:
                ...
                <div className='space-y-2'>
                  <div className='flex justify-between'>
                    ...
                    <span className='font-semibold'>
                      {securityStatus.overall.protectionScore}/130
                    </span>
                  </div>
                  <Progress
                  ...
                  <p className='text-sm text-gray-500'>
                    {securityStatus.overall.protectionScore >= 130
                      ? 'Quantum-safe protection active'
                      : securityStatus.overall.protectionScore >= 100
                        ? 'Maximum traditional protection'
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
                  <div className='space-y-4'>
                    <h4 className='font-semibold flex items-center space-x-2'>
                      <CheckCircle
                        className={`h-4 w-4 ${postQuantumStatus.initialized ? 'text-green-500' : 'text-gray-400'}`}
                      />
                      <span>Status</span>
                    </h4>
                    <div className='space-y-2'>
                      <div className='flex justify-between'>
                        ...
                        <span
                          className={
                            postQuantumStatus.initialized ? 'text-green-600' : 'text-red-600'
                          }
                        >
                      ...
                      <div className='flex justify-between'>
                        ...
                        <span className='font-semibold text-purple-600'>
                          {postQuantumStatus.protectionScore}/100
                        </span>
                      </div>
                    </div>
                  </div>
              ...
              <CardContent className='space-y-4'>
                ...
                <div className='space-y-2 text-sm'>
                  <div className='flex justify-between'>
                    ...
                    <span className='font-semibold'>
                      {securityStatus.antimalware.threatsDetected}
                    </span>
                  </div>
                  <div className='flex justify-between'>
                    <span>Quarantined Files:</span>
                    <span className='font-semibold'>
                      {securityStatus.antimalware.quarantinedFiles}
                    </span>
                  </div>
                </div>
              </CardContent>
              ...
              <CardContent className='space-y-4'>
                ...
                <div className='space-y-2 text-sm'>
                  <div className='flex justify-between'>
                    ...
                    <span className='font-semibold'>
                      {securityStatus.antivirus.definitionsCount}
                    </span>
                  </div>
                  <div className='flex justify-between'>
                  ...
                  <div className='flex justify-between'>
                    ...
                    <span className='font-semibold'>
                      {securityStatus.antivirus.virusesDetected}
                    </span>
                  </div>
                </div>
              </CardContent>
              ...
              <CardContent className='space-y-4'>
                ...
                <div className='space-y-2 text-sm'>
                  <div className='flex justify-between'>
                    ...
                    <span className='font-semibold'>
                      {securityStatus.antiHacking.suspiciousIPs}
                    </span>
                  </div>
                  <div className='flex justify-between'>
                  ...
                  <div className='flex justify-between'>
                    ...
                    <span
                      className={
                        securityStatus.antiHacking.ddosProtectionActive
                          ? 'text-green-600'
                          : 'text-red-600'
                      }
                    >
