...
export const ErrorMessages = {
  ...
  REGISTRATION_USER_EXISTS:
    'An account with this email, phone, username, or wallet address already exists',
  ...
  REGISTRATION_DATABASE_ERROR:
    'Unable to create account due to a technical issue. Please try again',
  ...
  LOGIN_PHONE_NOT_VERIFIED:
    'Please verify your phone number before logging in. Check your messages for a verification code',
  LOGIN_WALLET_NOT_FOUND: 'No account found with this wallet address',
  LOGIN_WALLET_CONNECTION_FAILED:
