  ...
  const getBadges = (): BadgeInfo[] => {
    ...
    const badges: BadgeInfo[] = [
      ...
      },
      {
        ...
        requirement: originalMethodVerified ? undefined : 'Verify your original signup method first',
      ...
      },
      {
        ...
        requirement: (hasOneOtherForm && originalMethodVerified) ? undefined : 'Earn Multi-Auth User badge first',
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              {availableBadges.map((badge) => (
                <div key={badge.id} className="flex items-center gap-3 p-3 border border-gray-200 rounded-lg opacity-75">
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              {lockedBadges.map((badge) => (
                <div key={badge.id} className="flex items-center gap-3 p-3 border border-gray-200 rounded-lg opacity-50">
